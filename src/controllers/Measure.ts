...
const isValidMeasureType = (
    measure_type: any
): measure_type is ListWhereOptions['measure_type'] => {
    const allowedMeasureTypes: ListWhereOptions['measure_type'][] = [
        'gas',
        'water',
    ]
...
const buildWhereObject = (
    ...
    if (measure_type && isValidMeasureType(measure_type)) {
        whereObject.measure_type =
            measure_type.toLowerCase() as ListWhereOptions['measure_type']
    }
